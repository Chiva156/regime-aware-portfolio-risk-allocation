...
Can we detect economically interpretable market regimes?
Do regimes correspond to materially different covariance and correlation structures?
Does regime-conditioned allocation reduce drawdowns?
Does dynamic risk-budget control outperform a robust constant-risk policy?
When does regime awareness fail or add no value?
